...
export const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setApiError(error instanceof Error ? error.message : 'Ошибка авторизации');
    } finally {
      setIsLoading(false);
    }
  };
          ...
          <div className="hidden lg:block space-y-8">
            ...
            <div className="space-y-4 animate-slide-in-left" style={{ animationDelay: '0.1s' }}>
              ...
              <p className="text-lg text-[#0D0F14]/60 leading-relaxed max-w-md">
                Управляйте складом легко и эффективно. Простой учёт без сложных CRM-систем.
              </p>
            </div>
            ...
            <div className="space-y-4 pt-4">
              {[
                ...
                { icon: '👥', text: 'Совместная работа в команде' },
                ...
                >
                  ...
                  <span className="text-[#0D0F14]/70 font-medium">{feature.text}</span>
                </div>
              ))}
            </div>
            ...
            <div className="flex gap-8 pt-8 animate-slide-in-left" style={{ animationDelay: '0.6s' }}>
              <div>
                ...
                <div className="text-sm text-[#0D0F14]/40">Активных пользователей</div>
              </div>
              <div>
                <div className="text-3xl font-black text-[#0D0F14]">50K+</div>
                <div className="text-sm text-[#0D0F14]/40">Товаров учтено</div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full animate-slide-in-right">
            ...
            <div className="bg-white rounded-3xl shadow-[0_20px_80px_rgba(0,0,0,0.12)] p-8 lg:p-10 border border-[#0D0F14]/05">
              ...
              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-[#0D0F14] mb-2">Вход в систему</h2>
                <p className="text-[#0D0F14]/50">Войдите, чтобы продолжить работу</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <label htmlFor="email" className="text-sm font-semibold text-[#0D0F14]/70 block">
                    Email адрес
                  </label>
                  <Input
                    id="email"
                ...
                <div className="flex items-center">
                  <input
                    id="remember"
                    type="checkbox"
                    className="w-4 h-4 rounded border-[#0D0F14]/20 text-[#FF6B35] focus:ring-[#FF6B35]/20 cursor-pointer"
                  />
                  <label htmlFor="remember" className="ml-2 text-sm text-[#0D0F14]/60 cursor-pointer">
                    Запомнить меня
                  </label>
                </div>
